...
Lemma zad1a (X Y : B) : 
  Or (And X (Not Y)) (Or (And (Not X) Y) (And (Not X) (Not Y))) = Or (Not X) (Not Y).
Proof.
...
intros Hlen.
  ...
  - intros y Hlen. destruct y as [|b y'];  simpl; try reflexivity. 
  - intros y Hlen. destruct y as [|b y']; try (simpl; reflexivity). inversion Hlen.
    simpl in Hlen. inversion Hlen.
    simpl. rewrite <-IHx; try reflexivity.
